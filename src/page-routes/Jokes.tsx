        ...
        <TableHead>
          <TableRow>
            ...
            <TableCell>
              ...
              >
                {sortOrder === "asc" ? <ArrowDropDown /> : <ArrowDropUpIcon />}
              </IconButton>
            </TableCell>
            <TableCell>
              Views
            ...
            : jokesFilterered.map((joke) =>
                joke?.CreatedAt ? (
                  <TableRow key={joke.id}>
                    ...
                    <TableCell>
                      <span style={{ color: handleViewsColor(joke.Views) }}>
                        {joke.Views}
                      </span>
                    </TableCell>
                  </TableRow>
